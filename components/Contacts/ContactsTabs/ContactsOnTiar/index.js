const ContactsOnTiar = (props) => {
  return (
    <div className="px-5">
      <h1 className="text-medium font-[14px] text-[#AEAEAE] py-1">7 Friends</h1>
        ...
        {Array(10)
          ...
          .map((i, idx) => (
            ...
            >
              ...
              <button className="bg-ownOrange p-1 rounded-md text-[12px] font-semibold">
                FOLLOW BACK
              </button>
            </div>
          ))}
